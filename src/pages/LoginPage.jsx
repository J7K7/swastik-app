...
function LoginPage() {
  ...
  return (
    <div className="h-screen overflow-hidden flex items-center justify-center">
      <div className="bg-white shadow-3xl rounded-xl">
        <div className="bg-gray-800 shadow shadow-gray-200 absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 ">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="#e31e24">
        ...
        <div className="flex flex-col mb-6">
          <div className="flex items-center text-lg">
            <svg className="absolute ml-3" width="24" viewBox="0 0 24 24" fill="#e31e24">
            ...
            <div className="flex flex-col mb-6">
          <div className="flex items-center text-lg">
            <svg className="absolute ml-3" viewBox="0 0 24 24" width="24" fill="#e31e24">
